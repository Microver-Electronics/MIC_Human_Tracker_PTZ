...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1807, 960)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.left_button = QtWidgets.QPushButton(self.centralwidget)
        self.left_button.setGeometry(QtCore.QRect(660, 470, 151, 61))
        self.left_button.setObjectName("left_button")
        self.up_button = QtWidgets.QPushButton(self.centralwidget)
        self.up_button.setGeometry(QtCore.QRect(820, 400, 151, 61))
        self.up_button.setObjectName("up_button")
        self.right_button = QtWidgets.QPushButton(self.centralwidget)
        self.right_button.setGeometry(QtCore.QRect(980, 470, 151, 61))
        self.right_button.setObjectName("right_button")
        self.down_button = QtWidgets.QPushButton(self.centralwidget)
        self.down_button.setGeometry(QtCore.QRect(820, 540, 151, 61))
        self.down_button.setObjectName("down_button")
        self.stop_button = QtWidgets.QPushButton(self.centralwidget)
        self.stop_button.setGeometry(QtCore.QRect(820, 470, 151, 61))
        self.stop_button.setObjectName("stop_button")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(620, 40, 581, 51))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(710, 850, 391, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.test_button = QtWidgets.QPushButton(self.centralwidget)
        self.test_button.setGeometry(QtCore.QRect(260, 370, 141, 30))
        self.test_button.setObjectName("test_button")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(130, 274, 449, 80))
        ...
        self.label_14.setGeometry(QtCore.QRect(90, 290, 31, 22))
        self.label_14.setObjectName("label_14")
        self.lne_read = QtWidgets.QLineEdit(self.centralwidget)
        self.lne_read.setEnabled(True)
        self.lne_read.setGeometry(QtCore.QRect(230, 460, 221, 91))
        self.lne_read.setObjectName("lne_read")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(280, 440, 131, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_4.setGeometry(QtCore.QRect(1350, 170, 111, 16))
        font = QtGui.QFont()
        ...
        self.label_7.setGeometry(QtCore.QRect(1390, 380, 41, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(1330, 410, 170, 80))
        ...
        self.label_10.setGeometry(QtCore.QRect(740, 220, 311, 81))
        font = QtGui.QFont()
        ...
        self.label_15.setGeometry(QtCore.QRect(250, 230, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.laser_motor_position_slider.setGeometry(QtCore.QRect(1330, 540, 160, 16))
        ...
        self.label_16.setGeometry(QtCore.QRect(1220, 540, 101, 16))
        self.label_16.setObjectName("label_16")
        self.laser_reset_button = QtWidgets.QPushButton(self.centralwidget)
        self.laser_reset_button.setGeometry(QtCore.QRect(1370, 600, 80, 23))
        self.laser_reset_button.setObjectName("laser_reset_button")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(1320, 220, 173, 41))
        ...
        self.laser_beam_angle_slider.setGeometry(QtCore.QRect(1330, 560, 160, 16))
        ...
        self.label_18.setGeometry(QtCore.QRect(1220, 560, 111, 16))
        self.label_18.setObjectName("label_18")
        self.label_19 = QtWidgets.QLabel(self.centralwidget)
        self.label_19.setGeometry(QtCore.QRect(1220, 580, 101, 16))
        self.label_19.setObjectName("label_19")
        self.laser_power_slider = QtWidgets.QSlider(self.centralwidget)
        self.laser_power_slider.setGeometry(QtCore.QRect(1330, 580, 160, 16))
        ...
        self.led_max_button.setGeometry(QtCore.QRect(1370, 500, 80, 23))
        self.led_max_button.setObjectName("led_max_button")
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(1320, 270, 173, 41))
        self.horizontalLayoutWidget_3.setObjectName("horizontalLayoutWidget_3")
        self.horizontalLayout_4 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_3)
        self.horizontalLayout_4.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_4.setObjectName("horizontalLayout_4")
        self.relay_on_button_2 = QtWidgets.QPushButton(self.horizontalLayoutWidget_3)
        self.relay_on_button_2.setObjectName("relay_on_button_2")
        self.horizontalLayout_4.addWidget(self.relay_on_button_2)
        self.relay_off_button_2 = QtWidgets.QPushButton(self.horizontalLayoutWidget_3)
        self.relay_off_button_2.setObjectName("relay_off_button_2")
        self.horizontalLayout_4.addWidget(self.relay_off_button_2)
        self.horizontalLayoutWidget_4 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(1320, 320, 173, 41))
        self.horizontalLayoutWidget_4.setObjectName("horizontalLayoutWidget_4")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.horizontalLayoutWidget_4)
        self.horizontalLayout_5.setContentsMargins(0, 0, 0, 0)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.relay_on_button_3 = QtWidgets.QPushButton(self.horizontalLayoutWidget_4)
        self.relay_on_button_3.setObjectName("relay_on_button_3")
        self.horizontalLayout_5.addWidget(self.relay_on_button_3)
        self.relay_off_button_3 = QtWidgets.QPushButton(self.horizontalLayoutWidget_4)
        self.relay_off_button_3.setObjectName("relay_off_button_3")
        self.horizontalLayout_5.addWidget(self.relay_off_button_3)
        self.autonom_on_button = QtWidgets.QPushButton(self.centralwidget)
        self.autonom_on_button.setGeometry(QtCore.QRect(710, 740, 201, 101))
        ...
        self.autonom_on_button.setPalette(palette)
        self.autonom_on_button.setObjectName("autonom_on_button")
        self.autonom_off_button = QtWidgets.QPushButton(self.centralwidget)
        self.autonom_off_button.setGeometry(QtCore.QRect(920, 740, 201, 101))
        palette = QtGui.QPalette()
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.Button, brush)
        self.autonom_off_button.setPalette(palette)
        self.autonom_off_button.setObjectName("autonom_off_button")
        self.horizontalLayoutWidget_5 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_5.setGeometry(QtCore.QRect(740, 300, 311, 80))
        ...
        self.ptz_speed_slider = QtWidgets.QSlider(self.horizontalLayoutWidget_5)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.ptz_speed_slider.sizePolicy().hasHeightForWidth())
        self.ptz_speed_slider.setSizePolicy(sizePolicy)
        self.ptz_speed_slider.setOrientation(QtCore.Qt.Horizontal)
        self.ptz_speed_slider.setObjectName("ptz_speed_slider")
        self.horizontalLayout_6.addWidget(self.ptz_speed_slider)
        self.go_to_origin_button = QtWidgets.QPushButton(self.centralwidget)
        self.go_to_origin_button.setGeometry(QtCore.QRect(820, 650, 171, 51))
        palette = QtGui.QPalette()
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.Button, brush)
        self.go_to_origin_button.setPalette(palette)
        self.go_to_origin_button.setObjectName("go_to_origin_button")
        self.start_body_tracking_button = QtWidgets.QPushButton(self.centralwidget)
        self.start_body_tracking_button.setGeometry(QtCore.QRect(810, 130, 171, 71))
        palette = QtGui.QPalette()
        ...
        brush = QtGui.QBrush(QtGui.QColor(239, 239, 239, 128))
        brush.setStyle(QtCore.Qt.SolidPattern)
        ...
        self.start_body_tracking_button.setPalette(palette)
        self.start_body_tracking_button.setObjectName("start_body_tracking_button")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Aselkon Armed Tracking System"))
        ...
        self.relay_on_button.setText(_translate("MainWindow", "Relay 1 On"))
        self.relay_off_button.setText(_translate("MainWindow", "Relay 1 Off"))
        ...
        self.relay_on_button_2.setText(_translate("MainWindow", "Relay 2 On"))
        self.relay_off_button_2.setText(_translate("MainWindow", "Relay 2 Off"))
        self.relay_on_button_3.setText(_translate("MainWindow", "Relay 3 On"))
        self.relay_off_button_3.setText(_translate("MainWindow", "Relay 3 Off"))
        self.autonom_on_button.setText(_translate("MainWindow", "Autonom Mode ON"))
        self.autonom_off_button.setText(_translate("MainWindow", "Autonom Mode OFF"))
        self.label_17.setText(_translate("MainWindow", "PTZ Speed"))
        self.go_to_origin_button.setText(_translate("MainWindow", "GO TO ORIGIN"))
        self.start_body_tracking_button.setText(_translate("MainWindow", "Start Body Tracking"))
