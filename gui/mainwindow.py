...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1149, 664)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.left_button = QtWidgets.QPushButton(self.centralwidget)
        self.left_button.setGeometry(QtCore.QRect(540, 270, 91, 30))
        self.left_button.setObjectName("left_button")
        self.up_button = QtWidgets.QPushButton(self.centralwidget)
        self.up_button.setGeometry(QtCore.QRect(640, 230, 91, 30))
        self.up_button.setObjectName("up_button")
        self.right_button = QtWidgets.QPushButton(self.centralwidget)
        self.right_button.setGeometry(QtCore.QRect(740, 270, 91, 30))
        self.right_button.setObjectName("right_button")
        self.down_button = QtWidgets.QPushButton(self.centralwidget)
        self.down_button.setGeometry(QtCore.QRect(640, 310, 91, 30))
        self.down_button.setObjectName("down_button")
        self.stop_button = QtWidgets.QPushButton(self.centralwidget)
        self.stop_button.setGeometry(QtCore.QRect(640, 270, 91, 30))
        self.stop_button.setObjectName("stop_button")
        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(350, 10, 541, 51))
        font = QtGui.QFont()
        font.setPointSize(30)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(410, 570, 391, 51))
        font = QtGui.QFont()
        font.setPointSize(20)
        self.label_2.setFont(font)
        self.label_2.setObjectName("label_2")
        self.test_button = QtWidgets.QPushButton(self.centralwidget)
        self.test_button.setGeometry(QtCore.QRect(180, 270, 141, 30))
        self.test_button.setObjectName("test_button")
        self.horizontalLayoutWidget = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget.setGeometry(QtCore.QRect(50, 174, 437, 80))
        ...
        self.lne_read.setGeometry(QtCore.QRect(140, 350, 221, 91))
        self.lne_read.setObjectName("lne_read")
        self.label_3 = QtWidgets.QLabel(self.centralwidget)
        self.label_3.setGeometry(QtCore.QRect(210, 330, 91, 20))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_4.setGeometry(QtCore.QRect(930, 150, 111, 16))
        font = QtGui.QFont()
        ...
        self.label_7.setGeometry(QtCore.QRect(960, 350, 41, 16))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(900, 380, 170, 80))
        ...
        self.label_10.setGeometry(QtCore.QRect(620, 150, 151, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.label_15.setGeometry(QtCore.QRect(170, 130, 171, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.laser_motor_position_slider.setGeometry(QtCore.QRect(900, 510, 160, 16))
        ...
        self.label_16.setGeometry(QtCore.QRect(790, 510, 101, 16))
        self.label_16.setObjectName("label_16")
        self.laser_reset_button = QtWidgets.QPushButton(self.centralwidget)
        self.laser_reset_button.setGeometry(QtCore.QRect(940, 570, 80, 23))
        self.laser_reset_button.setObjectName("laser_reset_button")
        self.horizontalLayoutWidget_2 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(900, 200, 173, 41))
        ...
        self.laser_beam_angle_slider.setGeometry(QtCore.QRect(900, 530, 160, 16))
        ...
        self.label_18.setGeometry(QtCore.QRect(790, 530, 111, 16))
        self.label_18.setObjectName("label_18")
        self.label_19 = QtWidgets.QLabel(self.centralwidget)
        self.label_19.setGeometry(QtCore.QRect(790, 550, 101, 16))
        self.label_19.setObjectName("label_19")
        self.laser_power_slider = QtWidgets.QSlider(self.centralwidget)
        self.laser_power_slider.setGeometry(QtCore.QRect(900, 550, 160, 16))
        ...
        self.led_max_button.setGeometry(QtCore.QRect(940, 470, 80, 23))
        self.led_max_button.setObjectName("led_max_button")
        self.horizontalLayoutWidget_3 = QtWidgets.QWidget(self.centralwidget)
        self.horizontalLayoutWidget_3.setGeometry(QtCore.QRect(900, 250, 173, 41))
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(900, 300, 173, 41))
